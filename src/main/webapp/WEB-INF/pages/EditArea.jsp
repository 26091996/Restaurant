                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">Cập nhật khu vực</h4>
                            </div>
                            <div class="card-body">
                                <fieldset class="form-horizontal">
                                    <form:form action="/saveUpdateArea" method="post" modelAttribute="command">
                                        ...
                                        <div class="form-group">
                                            <form:label path="areaName"
                                                        class="bmd-label-floating">Tên loại khu vực</form:label>
                                            <div class="col-md-12">
