                            ...
                            <div class="ibox">
                                <div class="ibox-content">
                                    <div class="form-group" align="right">
                                        <a class="btn btn-w-m btn-primary" href="AddEmployee">Thêm nhân viên</a>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="tb-employee"
                                                   class="footable table table-stripped toggle-arrow-tiny tablet breakpoint footable-loaded"
                                                   data-page-size="15">
                                                <thead class=" text-primary">
                                                <tr>
                                                    <th data-hide="phone"
                                                        class="footable-visible footable-sortable">Tên nhân viên<span
                                                                class="footable-sort-indicator"></span>
                                                    </th>
                                                    <th data-hide="phone"
                                                        class="footable-visible footable-sortable">User Name<span
                                                            class="footable-sort-indicator"></span></th>
                                                    <th data-hide="phone"
                                                        class="footable-visible footable-sortable">Số điện thoại<span
                                                            class="footable-sort-indicator"></span>
                                                    </th>
                                                    <th data-hide="phone"
                                                        class="footable-visible footable-sortable">Quyền<span
                                                            class="footable-sort-indicator"></span>
                                                    </th>
